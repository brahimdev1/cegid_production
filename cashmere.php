    ...
    <form>
        ...
        <select id="magasin" name="magasin">
           <option value="select">----selectionner une Dimension----</option>
            <option value="magasin1">CASHMERE 90x190</option>
            <option value="magasin2">CASHMERE 90x200</option>
            <option value="magasin3">CASHMERE 100x190</option>
            <option value="magasin4">CASHMERE 100x200</option>
            <option value="magasin5">CASHMERE 120x200</option>
            <option value="magasin6">CASHMERE 140x190</option>
            <option value="magasin7">CASHMERE 140x200</option>
            <option value="magasin8">CASHMERE 160x190</option>
            <option value="magasin9">CASHMERE 160x195</option>
            <option value="magasin10">CASHMERE 160x200</option>
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            magasinSelect.addEventListener("change", function () {
                ...
                switch (selectedMagasin) {
                    case "magasin1":
                        photoMagasin.src = "./Etiquette_matelas/cashmere/etiqutte cashmere matelas 90X190 CM-1.png";
                        break;
                    case "magasin2":
                        photoMagasin.src = "./Etiquette_matelas/cashmere/etiqutte cashmere matelas 90X200 CM-1.png";
                        break;
                    case "magasin3":
                        photoMagasin.src = "./Etiquette_matelas/cashmere/etiqutte cashmere matelas 100X190 CM-1.png";
                        break;
                    case "magasin4":
                        photoMagasin.src = "./Etiquette_matelas/cashmere/etiqutte cashmere matelas 100X200 CM-1.png";
                        break; 
                    case "magasin5":
                        photoMagasin.src = "./Etiquette_matelas/cashmere/etiqutte cashmere matelas 120X200 CM-1.png";
                        break;                       
                    case "magasin6":
                        photoMagasin.src = "./Etiquette_matelas/cashmere/etiqutte cashmere matelas 140X190 CM-1.png";
                        break;
                    case "magasin7":
                        photoMagasin.src = "./Etiquette_matelas/cashmere/etiqutte cashmere matelas 140X200 CM-1.png";
                        break;
                    case "magasin8":
                        photoMagasin.src = "./Etiquette_matelas/cashmere/etiqutte cashmere matelas 160X190 CM-1.png";
                        break;
                    case "magasin9":
                        photoMagasin.src = "./Etiquette_matelas/cashmere/etiqutte cashmere matelas 160X195 CM-1.png";
                        break;
                    case "magasin10":
                        photoMagasin.src = "./Etiquette_matelas/cashmere/etiqutte cashmere matelas 160X200 CM-1.png";
                        break;
