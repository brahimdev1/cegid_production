    ...
    <form>
        ...
        <select id="magasin" name="magasin">
           <option value="select">----selectionner une Dimension----</option>
            <option value="magasin1">DANIA 90x190</option>
            <option value="magasin2">DANIA 100x200</option>
            <option value="magasin3">DANIA 120x190</option>
            <option value="magasin4">DANIA 140x190</option>
            <option value="magasin5">DANIA 140x200</option>
            <option value="magasin6">DANIA 160x190</option>
            <option value="magasin7">DANIA 160x200</option>
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            magasinSelect.addEventListener("change", function () {
                ...
                switch (selectedMagasin) {
                    case "magasin1":
                        photoMagasin.src = "./Etiquette_matelas/dania/etiqutte succes-dania matelas 90X190 CM-1.png";
                        break;
                    case "magasin2":
                        photoMagasin.src = "./Etiquette_matelas/dania/etiqutte succes-dania matelas 100X200 CM-1.png";
                        break;
                    case "magasin3":
                        photoMagasin.src = "./Etiquette_matelas/dania/etiqutte succes-dania matelas 120X190 CM-1.png";
                        break;
                     case "magasin4":
                        photoMagasin.src = "./Etiquette_matelas/dania/etiqutte succes-dania matelas 140X190 CM-1.png";
                        break; 
                        case "magasin5":
                        photoMagasin.src = "./Etiquette_matelas/dania/etiqutte succes-dania matelas 140X200 CM-1.png";
                        break;                       
                        case "magasin6":
                        photoMagasin.src = "./Etiquette_matelas/dania/etiqutte succes-dania matelas 160X190 CM-1.png";
                        break;
                        case "magasin7":
                        photoMagasin.src = "./Etiquette_matelas/dania/etiqutte succes-dania matelas 160X200 CM-1.png";
                        break;
