...
<div class="pdf-page" id="invoice">
    <h1>processus de production </h1>
    <br>
    <p>Client : <?php echo $page1_value; ?></p>
...
$sql = "SELECT WOP_LIGNEORDRE, WOP_PHASELIB, WOP_QACCSAIS, WOP_QLANSAIS, WOP_QRECSAIS, WOL_LIBELLE, time_in, time_out, difference
        FROM (
            ...
            WHERE GPA_LIBELLE = 'MYLM SARL YATOUT HOME AGADIR' 
...
while ($row = sqlsrv_fetch_array($stmt, SQLSRV_FETCH_ASSOC)) {
    if ($row['WOP_LIGNEORDRE'] !== $prevWOP_LIGNEORDRE) {
        ...
        echo "<h2>Ordre de Fabrication : " . $row['WOP_LIGNEORDRE'] .  "</h2>"; // Affiche la nouvelle valeur de WOP_LIGNEORDRE
        echo "<h2>Matelas : " . $row['WOL_LIBELLE'] .  "</h2>"; // Affiche la nouvelle valeur de WOP_LIGNEORDRE
        echo "<h2>Matelas :   ---------------------------------------------------------------  </h2>"; // Affiche la nouvelle valeur de WOP_LIGNEORDRE
